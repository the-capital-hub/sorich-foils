...
const products = [
  // 1. Strip Pack
  {
    ...
    aboutSection: {
      ...
      paragraphs: [
        "Strip packaging is widely used in the pharmaceutical, confectionery, engineering, and industrial sectors. Designed for high-speed precision, strip packaging machines can handle up to 2,400 units per minute. Products pass through a stainless steel feeding system into sealing roller cavities, where laminated foils pack and seal them in a continuous strip. The strip then passes through vertical and horizontal gutter assemblies to deliver packages in the desired sizes. Furthermore, strip packaging machines are designed to meet stringent industry standards, ensuring product safety and compliance with regulatory requirements.",
      ],
    },
    keyFeatures: [
      {
      ...
      },
      {
        ...
        description: "Continuous form-fill-seal process ensures consistent quality and efficiency.",
      },
      {
  ...
  // 2. Blister Pack
  {
    ...
    aboutSection: {
      ...
      paragraphs: [" Blister packs are pre-formed packaging widely used for pharmaceuticals, including tablets and capsules. They protect products from external factors such as humidity and contamination, while opaque blisters also shield light-sensitive products from UV rays. In addition to protection, blister packs also offer convenience in handling and dosage accuracy, as each unit is individually sealed. This not only helps in maintaining product integrity but also supports patient compliance by making it easier to track daily medication intake. Furthermore, blister packaging plays a crucial role in tamper evidence, ensuring the safety and authenticity of the product for end users. "]
    },
    keyFeatures: [
      {
        _id: "671fb91a6b8f4c1e24a9f121",
        title: "Push-through design",
        description: "Suitable for tablets and capsules, ensuring push-through packaging.",
      },
      {
      ...
      },
      {
        ...
        description:
          "Provides long-term protection against humidity, contamination, and light.",
      },
      {
        _id: "671fb91a6b8f4c1e24a9f124",
        title: "Tamper evident",
        description:
          " Each blister is formed, filled, and sealed on the same equipment, known as a blister line.",
      },
      {
        _id: "671fb91a6b8f4c1e24a9f125",
        title: "Globally compliant",
        description: " Globally used and trusted by pharmaceutical companies.",
      },
    ],
  },
  ...
  // 3. CR Foil
  {
    ...
    aboutSection: {
      ...
      paragraphs: [
        " CR (Child-Resistant) Foil is designed to minimize the risk of children accidentally ingesting hazardous substances. It is widely used for prescription drugs, over-the-counter medications, pesticides, and household chemicals, in compliance with regulatory requirements. This specialized packaging features a secure mechanism, such as a push-and-turn or squeeze-and-pull design, which is difficult for young children to open but remains accessible for adults. In addition to improving safety, CR foil packaging helps in reducing accidental poisoning incidents, contributing to public health protection. It also provides tamper-evidence, ensuring the integrity and authenticity of the product for consumers. ",
      ],
    },
    keyFeatures: [
      {
        ...
        description:
          " Provides child-resistant protection for tablets and capsules",
      },
      {
        _id: "671fb91a6b8f4c1e24a9f132",
        title: "Custom base",
        description: " Available with paper or PVC base.",
      },
      {
      ...
      },
      {
        ...
        title: "Pharma grade",
        description: "Commonly used in Europe for blister packaging of generic medicines.",
      },
    ],
  },
  ...
  // 4. Lid Aluminum Foil
  {
    ...
    aboutSection: {
      ...
      paragraphs: [
       "Thin and lightweight, these aluminum foil lids serve as temporary yet secure covers for disposable food containers. They help preserve freshness, prevent contamination, and maintain the temperature of the food for longer durations. These lids are ideal for packaging in the food service and catering industry. They can be fully customized with logos, images, and other branding details to meet specific client requirements, ensuring both functionality and visual appeal."
      ],
    },
    keyFeatures: [
      {
        ...
        description: "Made from soft-tempered aluminum foil, 30–40 microns thick.",
      },
      {
        _id: "671fb91a6b8f4c1e24a9f142",
        title: "Multi-layer coating",
        description: "Coated with PP, PS, or universal lacquer for enhanced durability.",
      },
      {
        _id: "671fb91a6b8f4c1e24a9f143",
        title: "Custom branding",
        description: " Fully customizable to suit branding and packaging needs.",
      },
      {
        _id: "671fb91a6b8f4c1e24a9f144",
        title: "Hygienic seal",
        description: " Ideal for disposable food product containers.",
      },
      {
        _id: "671fb91a6b8f4c1e24a9f145",
        title: "Lightweight",
        description: " Widely used in the food and dairy industry.",
      },
    ],
  },
  ...
  // 5. Confectionery Packaging
  {
    ...
    aboutSection: {
      ...
      paragraphs: [
        " Aluminum’s protective qualities and recyclability make it a preferred choice for confectionery packaging. Our aluminum foil offers durability, safety, and aesthetic appeal for chocolates, candies, and other confectionery products. It helps maintain the product’s taste, aroma, and texture while providing an elegant finish that enhances shelf presence. With options for customization in thickness, design, and printing, our foil ensures both functional protection and premium branding for confectionery manufacturers.",
      ],
    },
    keyFeatures: [
      {
        ...
        title: "Thin foil",
        description: " Soft-tempered aluminum foil, 7–15 microns thick.",
      },
      {
        _id: "671fb91a6b8f4c1e24a9f152",
        title: "Food-grade coating",
        description: "Ideal for high-quality confectionery packaging.",
      },
      {
        _id: "671fb91a6b8f4c1e24a9f153",
        title: "Printed design",
        description: " Printed designs with food-grade coating and heat-seal lacquer.",
      },
      {
        _id: "671fb91a6b8f4c1e24a9f154",
        title: "Recyclable",
        description: "Fully recyclable and environmentally friendly.",
      },
      {
        _id: "671fb91a6b8f4c1e24a9f155",
        title: "Premium finish",
        description: " Provides excellent protection for chocolates and confectionery.",
      },
    ],
  },
  ...
  // 7. Holographic Products
  {
    ...
    aboutSection: {
      ...
      paragraphs: [
       " Holographic hot stamping foils are used for the authentication of valuable documents such as certificates, mark sheets, and share certificates. Fusion Mark foils can be applied to a variety of surfaces including paper, plastics, and leather. These foils not only enhance security by preventing counterfeiting but also add a premium and visually striking appearance to the product. With customizable holographic patterns, colors, and designs, they offer both functional protection and aesthetic appeal across diverse applications."
      ],
    },
    keyFeatures: [
      {
        ...
        title: "Non-removable",
        description: " Non-removable and non-transferable for enhanced security.",
      },
      {
        _id: "671fb91a6b8f4c1e24a9f172",
        title: "Continuous patterns",
        description: "Available as continuous pattern holograms or individual index marks.",
      },
      {
        _id: "671fb91a6b8f4c1e24a9f173",
        title: "High security",
        description: " High-security holographic aluminum foils for pharmaceutical packaging.",
      },
      {
        _id: "671fb91a6b8f4c1e24a9f174",
        title: "Multi-surface use",
        description: " Ideal for sachets, gift wrappers, and other premium applications.",
      },
      {
    ...
    keyFeatures: [
      {
        ...
        description:
          "High-strength paper for tear resistance",
      },
      {
        _id: "671fb91a6b8f4c1e24a9f192",
        title: "Custom printing",
        description: "Customizable printing for security and branding",
      },
      {
        _id: "671fb91a6b8f4c1e24a9f193",
        title: "Smooth finish",
        description: "Smooth finish for easy handling",
      },
      {
        _id: "671fb91a6b8f4c1e24a9f194",
        title: "Moisture-resistant",
        description: " Moisture-resistant coating for durability",
      },
      {
    ...
    keyFeatures: [
      {
        ...
        title: "High clarity",
        description: "Excellent clarity and gloss for premium appearance.",
      },
      {
        _id: "671fb91a6b8f4c1e24a9f232",
        title: "Superior seal strength",
        description: "Strong sealability and toughness.",
      },
      {
      ...
      },
      {
        ...
        description: "Ideal for pharmaceutical, food, and specialty packaging.",
      },
    ],
  },
];
