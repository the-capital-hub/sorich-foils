		...
		<section className="flex flex-col items-center justify-center w-full bg-white text-black pt-28">
			...
			<div className="relative w-full max-w-7xl mt-10">
				...
				<div className="md:absolute top-[45%] left-[23%] transform md:-translate-x-1/2 md:translate-y-[120px] mt-5 md:mt-0 text-center px-4">
					<h1
						className={`text-xl md:text-9xl font-semibold ${instrument.className} tracking-tight`}
					>
						ABOUT US
					</h1>
					<p
						className={`text-[#31373D] mt-4 md:max-w-2xl mx-auto ${instrument.className} md:text-2xl`}
					>
				...
				<div className="md:max-w-7xl w-full bg-white rounded-[20px] md:shadow-sm md:border-b-10 md:border-l-10 black p-0 lg:p-12 flex flex-col lg:flex-row gap-10">
					...
					<div className="flex flex-col items-center bg-[#F8F8F8] rounded-2xl overflow-hidden p-4">
						...
						<div className="bg-black text-white w-full text-center py-3">
							<h5 className={`text-xl ${fustat.className}`}>
								Mr. Chandrahas B. Kotian
							</h5>
							<p
								className={`text-sm opacity-80 mt-16 text-[#E6FAF5] ${fustat.className}`}
							>
								Our Founder
							</p>
					...
					<div className="flex-1">
						<h2
							className={`text-5xl font-bold mb-4 text-[#1A1A1A] ${inter.className}`}
						>
							Our Founder
						</h2>
						<p
							className={`text-[#31373D] text-xl leading-relaxed mb-4 ${instrument.className} font-normal`}
						>
						...
						>
							...
							Kotian leveraged his experience to become a successful
							entrepreneur within just seven years. In 2011, he founded Sorich
							Foils Private Limited at Sarigam, Gujarat, starting with just 4–5
							clients. Today, under his inspiring leadership, the company serves
							over 150 clients, setting benchmarks in quality, innovation, and
			...
			<div className="w-full flex justify-center mt-4 md:mt-20 px-6 lg:mb-20">
				<div className="max-w-7xl w-full bg-[#F0F0F0] rounded-[20px] p-8 lg:p-12 items-center gap-10 shadow-sm border border-gray-200">
					...
					<h2
						className={`text-4xl md:text-5xl font-bold mb-2 ${instrument.className} text-center`}
					>
						Our Company
					</h2>
					...
					<div className="flex flex-col lg:flex-row mt-4 md:mt-20">
						<div className="flex-1">
							<h3
								className={`text-3xl md:text-5xl font-semibold mb-4 ${instrument.className}`}
							>
							...
							>
								Our Company was incorporated as "Sorich Foils Private Limited"
								on January 19, 2011 under the Companies Act, 1956, with the
								Registrar of Companies, Ahmedabad, Gujarat. Pursuant to a
								special resolution of our shareholders dated January 31, 2018,
								our Company was converted into a public limited company and a
								fresh certificate of incorporation was issued by the Registrar
								of Companies, Ahmedabad, Gujarat, on February 7, 2018. The
