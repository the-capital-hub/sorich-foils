						...
						<div>
							...
							<p className={`text-xl leading-relaxed font-normal text-center md:text-left`}>
								...
								>
									...
									milestones. His strategic insights and business acumen have
									been pivotal in shaping the Company’s growth trajectory.
								</span>
							</p>
						</div>
						...
						<div>
							...
							<p className="text-xl leading-relaxed text-center md:text-left">
								...
								>
									...
									sustainable, and reliable packaging solutions that add value
									to our clients and adhere to evolving global standards.
								</span>
							</p>
						</div>
					</div>
