...
export default function TestimonialSection() {
  ...
  return (
    <section className="py-20 px-4 bg-[rgba(246,246,246,1)]">
      <div className="max-w-7xl mx-auto text-center">
        {/* Section Header */}
        <div className="flex justify-center mb-4">
          <span className="text-sm font-medium bg-[#F9FAFB] border-[#EAECF0] px-4 py-1 rounded-full flex items-center gap-1">
            <span>🔥</span> TESTIMONIAL
          </span>
        </div>

        <h2 className={`text-3xl lg:text-5xl font-extrabold text-gray-900 mb-14 ${instrument.className}`}>
    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p
            className={`text-xs ${
              t.bg === "bg-[#9DC834]" ? "text-white/90" : "text-gray-600"
            }`}
          >
            {t.position}
          </p>
